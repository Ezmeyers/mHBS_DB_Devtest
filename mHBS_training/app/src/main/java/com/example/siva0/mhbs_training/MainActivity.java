...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // init data we want to access
        LoadingController.enableLoading(this, ResourceType.RELATIONSHIPTYPES);
        LoadingController.enableLoading(this, ResourceType.DASHBOARDS_CONTENT);
        ...
        List<DashboardItemContent> doc = MetaDataController.getDashboardContent();
        if(doc.isEmpty()){
            Log.d("isEmpty",doc.getClass().getSimpleName());
         //   Log.d("trying",doc.get(0).getType());
        }
    }
